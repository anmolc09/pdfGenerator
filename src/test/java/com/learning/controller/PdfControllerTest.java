...
public class PdfControllerTest {
    ...
    public void setUp() {
        ...
        List<Invoice.Items> items = new ArrayList<>();
        Invoice.Items item = new Invoice.Items();
    ...
    void testGeneratePdf() throws Exception {
        when(pdfService.createPdf(invoice)).thenReturn(serializeInvoice(invoice));
        ResponseEntity<byte[]> responseEntity = pdfController.generatePdfFile(invoice);
